...
urlpatterns = [
    ...
    path("file/upload/<slug:folder_slug>/", views.FileUploadView.as_view(), name="file_upload_with_folder"),  # با slug
    ...
    path("folder/create/<slug:folder_slug>/", views.FolderCreateView.as_view(), name="folder_create_with_parent"),  # مسیر جدید
